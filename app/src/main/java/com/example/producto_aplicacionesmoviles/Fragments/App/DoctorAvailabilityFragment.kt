 ...
 * Use the [DoctorAvailabilityFragment.newInstance] factory method to
...
class DoctorAvailabilityFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DoctorAvailabilityFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DoctorAvailabilityFragment().apply {
