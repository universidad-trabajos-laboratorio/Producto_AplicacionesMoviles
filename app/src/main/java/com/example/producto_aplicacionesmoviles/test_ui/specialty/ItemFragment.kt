...
class ItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.test_specialty_fragment_item_list, container, false)

        specialtyViewModel.specialtiesResponse.observe(viewLifecycleOwner, Observer { specialties ->
            // Set the adapter
            if (view is RecyclerView) {
                with(view) {
                    ...
                    adapter = MyItemRecyclerViewAdapter(specialties)
                }
            }
        })
